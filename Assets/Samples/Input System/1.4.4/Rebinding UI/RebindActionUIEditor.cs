...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_RebindCompeleteEventProperty = serializedObject.FindProperty("m_RebindCompleteEvent");
            m_ShowOverlayScreenEventProperty = serializedObject.FindProperty("m_ShowOverlayEvent");
            m_HideOverlayScreenEventProperty = serializedObject.FindProperty("m_HideOverlayEvent");
            m_OnRebindCancelledProperty = serializedObject.FindProperty("m_OnRebindCancelled");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_RebindCompeleteEventProperty);
                EditorGUILayout.PropertyField(m_UpdateBindingUIEventProperty);
                EditorGUILayout.PropertyField(m_ShowOverlayScreenEventProperty);
                EditorGUILayout.PropertyField(m_HideOverlayScreenEventProperty);
                EditorGUILayout.PropertyField(m_OnRebindCancelledProperty);
            }
        ...
        private SerializedProperty m_OnRebindCancelledProperty;
        private SerializedProperty m_UpdateBindingUIEventProperty;
        private SerializedProperty m_DisplayStringOptionsProperty;
        private SerializedProperty m_RebindCompeleteEventProperty;
        private SerializedProperty m_ShowOverlayScreenEventProperty;
        private SerializedProperty m_HideOverlayScreenEventProperty;
